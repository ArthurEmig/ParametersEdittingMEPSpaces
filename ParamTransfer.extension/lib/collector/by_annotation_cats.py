...
doc = revit.doc
ALL_CATEGORIES = [c for c in doc.Settings.Categories if c.CategoryType == DB.CategoryType.Annotation]
...
NAME = 'By Annotation Categories'
# Short description of the collector
DESCRIPTION = 'Select elements by Annotation Categories'
# Author
AUTHOR = 'Junfeng Xiao'
...
class AnnotationElementsCollector(Collector):
    name = NAME
    _author = AUTHOR
    MAX_CAT_IN_DESC = 5
...
"""
export = AnnotationElementsCollector()
